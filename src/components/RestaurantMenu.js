...
const RestaurantMenu=()=>{
    ...
    return !restaurant ? (<Shimmer/>) : (
        ...
        <div className="p-3">
            ...
            <h3 className="px-4 font-semibold text-lg">Area: {restaurantApi?.data?.cards[0]?.card?.card?.info?.areaName}</h3>
            <h3 className="px-4 font-semibold text-lg">City: {restaurantApi?.data?.cards[0]?.card?.card?.info?.city}</h3>
            <h3 className="px-4 font-semibold text-lg">Rating: {restaurantApi?.data?.cards[0]?.card?.card?.info?.avgRating} stars</h3>
